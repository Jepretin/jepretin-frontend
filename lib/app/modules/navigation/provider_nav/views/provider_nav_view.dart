...
class ProviderNavView extends GetView<ProviderNavController> {
  const ProviderNavView({super.key});
  @override
  Widget build(BuildContext context) {
    return GetBuilder(
      init: ProviderNavController(),
  ...
  Widget _navBarIcon(
      ProviderNavController controller, int index, String assetName) {
    return IconButton(
